...
{
    [TestFixture]
    public class UserControllerTests : BaseControllerTests<UserProfileEntity>
    {
        ...
        //        UserName = "NewUser"
        //    };
        //    var expectedUserEntity = Mapper.Map<UserProfileEntity>(userProfile);
        //    var mockRepository = new Mock<IUserProfileService>();
