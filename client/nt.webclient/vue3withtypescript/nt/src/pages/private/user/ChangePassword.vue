          ...
          <div class="card-body">
            <form class="form needs-validation" @submit.prevent="onSubmit">
              ...
              <div
                ...
                v-if="v$.formData.oldPassword.$error"
              >
                <ValidationMessage
                  :messages="
                    v$.formData.oldPassword.$errors.map((x: any) => x.$message)
                  "
                  v-bind:isError="true"
                />
              </div>
              ...
              <div
                class="d-flex justify-content-center"
                v-if="v$.formData.newPassword.$error"
              >
                <ValidationMessage
                  :messages="
                    v$.formData.newPassword.$errors.map((x: any) => x.$message)
                  "
                  v-bind:isError="true"
                />
              </div>
              ...
              >
                <ValidationMessage
                  :messages="
                    v$.formData.confirmPassword.$errors.map(
                      (x: any) => x.$message,
                    )
                  "
                  v-bind:isError="true"
