import {
  ...
  IGetProfileResponse,
} from '../types/apirequestresponsetypes/User';
...
class UserApiService extends ApiServiceBase {
  ...
  public async registerUser(
    ...
    return await this.invoke<IRegisterUserResponse>({
      method: 'post',
  ...
  public async changePassword(
    ...
    return await this.invoke<IChangePasswordResponse>({
      method: 'post',
  ...
  public async updateUser(
    ...
    return await this.invoke<IUpdateUserResponse>({
      method: 'post',
  ...
  public async uploadProfileImage(
    request: IUploadProfileImageRequest
  ): Promise<IUploadProfileImageResponse> {
  ...
  public async getProfileImage(
    request: IGetProfileImageRequest
  ): Promise<Blob | null> {
